...
public class ResultBuilderTest
{
    ...
    [Test]
    public void BuildDocumentsBySignTest()
    {
        // Arrange
        ...
        // Assert
        Xunit.Assert.Equal(result.documentsBySign.Keys.Count, _sut.GetResult().documentsBySign.Keys.Count);
        foreach (var entry in _sut.GetResult().documentsBySign)
        {
            Xunit.Assert.True(entry.Value.SequenceEqual(result.documentsBySign[entry.Key]));
        }
    }
    ...
    public void BuildDocumentsTest()
    {
        ...
        // Assert
        Xunit.Assert.True(result.documents.SequenceEqual(_sut.GetResult().documents));
    }
}
